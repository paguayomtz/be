...
?>
    ...
    <div class="col s12">
        ...
        <a href="#" class="btn grey darken-1 valign-wrapper" onClick="swal({title: '¿Deseas eliminar la reseña?', text: 'No podras recuperarla despues', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Eliminar'}).then((result) => {if (result.value) { location.href='../resena/del_resena.php?id=<?= $f[1] ?>'; } }) "> Eliminar Reseña </a>
    </div>
