                        ...
                        <div class="col s12">        
                            ...
                            <table id="curris" class="bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>                                             
                                        <td>                                            
                                            <a class="blue white-text" style="padding: 5px 10px; border-radius: 50px;" href="#" id="cliente<?php echo $f['id_cliente']; ?>" onClick="editar(<?php echo $f['id_cliente'] ?>)"> <?php echo $f['cliente'] ?> </a>
                                            <a class="ocultar grey white-text" style="padding: 5px 10px; border-radius: 50px;" href="#" id="cli<?php echo $f['id_cliente']; ?>" onClick="guardar(<?php echo $f['id_cliente'] ?>)"> <?php echo $f['cliente'] ?> </a>                                      
                                        </td>                                                                       
                                    ...
                                    <tr class="ocultar" id="frm<?php echo $f['id_cliente']; ?>">
                                        ...
                                        <td>                                      
                                            <button type="submit" class="btn white-text orange darken-4">Editar<i class="material-icons" >send</i> </button>                                   
                                        </td>
                                        </form>
                                    </tr>
                                    <?php } $cn->close();?>
                ...
                <div id="agregar">                
                    <form class="form" action="ins_cliente.php" method="post" enctype="multipart/form-data" autocomplete="off">
                        <div class="input-field">
                            ...
                            <input type="text" name="cliente" title="Campo faltante" id="cliente" onblur="may(this.value, this.id)" required>
                            <label for="cliente">Cliente</label>                                                
                        </div>
                        <div class="input-field">
                            <i class="material-icons prefix">account_circle</i>                                                 
                            <input type="text" name="contacto" title="Campo faltante" id="contacto" onblur="may(this.value, this.id)" required>
                            <label for="contacto">Contacto</label>                                                
                        </div>
                        <div class="input-field">
                            <i class="material-icons prefix">call_end</i>                                                 
                            <input type="text" name="tel" title="Campo faltante" id="tel" required>
                            <label for="tel">Teléfono</label>                                                
                        </div>
                        <div class="input-field">
                            <i class="material-icons prefix">email</i>                                                 
                            <input type="text" name="mail" title="Campo faltante" id="mail" required>
                            <label for="mail">Email</label>                                                
                        </div>                                    
